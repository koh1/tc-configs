...
if [ "$1" = "hfsc" ] ; then
    ...
    /sbin/tc class add dev $DEV parent 1:10 classid 1:11 hfsc sc m1 2400kbit d 2ms m2 1200kbit    
    /sbin/tc class add dev $DEV parent 1:10 classid 1:12 hfsc sc m2 16mbit
...
#    /sbin/tc class add dev $DEV parent 1:20 classid 1:22 hfsc sc rate 4mbit ul rate 4mbit
    ...
    /sbin/tc class add dev $DEV parent 1:10 classid 1:11 htb rate 1200kbit
    /sbin/tc class add dev $DEV parent 1:10 classid 1:12 htb rate 6800kbit ceil 16mbit
